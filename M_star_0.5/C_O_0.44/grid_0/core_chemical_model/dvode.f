...
C              In addition, the user may increase gggg to avoid
...
C
      DATA  MORD(1) /12/, MORD(2) /5/, MXSTP0 /100000/, MXHNL0 /10/
      DATA ZERO /0.0D0/, ONE /1.0D0/, TWO /2.0D0/, FOUR /4.0D0/,
     1     PT2 /0.2D0/, HUN /100.0D0/

C **** SOME WRITE STATEMENTS TO TEST PASSED ARGUMENTS ****
c      WRITE (*,*) NEQ
c      WRITE (*,*) Y(133),"   ",YDOT(133)
...
C-----------------------------------------------------------------------
c      WRITE(LUNIT,999) ISTATE
c 999  FORMAT(3X, 'ISTATE = ',I4)
